    ...
    <div className='flex h-full flex-col'>
      ...
      {mail ? (
        <div className='flex flex-1 flex-col'>
          ...
          <Separator />
          {/* Render messages */}
          <ScrollArea className='flex-1 overflow-y-auto p-4 text-sm whitespace-pre-wrap'>{mail.text}</ScrollArea>
          <Separator className='mt-auto' />
          <div className='p-4'>
            <form>
              <div className='grid gap-4'>
                <Textarea className='max-h-40 p-4' placeholder={`Reply ${mail.name}...`} />
