          ...
          return (
            <div
              ...
              className={cn(
                ...
                'cursor-not-allowed opacity-70 border border-transparent',
            ...
            >
              ...
              {item.badge && (
                <Badge 
                  variant="outline" 
                  className="ml-2 bg-amber-500/10 text-amber-500 border-amber-500/20 px-2 py-0.5 text-[10px] font-medium"
                >
                  {item.badge}
                </Badge>
              )}
